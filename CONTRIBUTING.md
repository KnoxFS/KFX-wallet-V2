Contributing to KFX Core
============================

The KFX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the KFX Core project, and is not to be
confused with overall KFX Network Protocol consensus changes.

Whether a pull request is merged into KFX Core rests with the project merge
...
Patches that change KFX consensus rules are considerably more involved than
...
Where a patch set proposes to change the KFX consensus, it must have been
...
The project leader is the release manager for each KFX Core release.
