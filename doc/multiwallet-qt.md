...
In order to support loading of multiple wallets in kfx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kfx.cpp.
...
Changes to kfx.cpp
----------------------
kfx.cpp is the entry point into kfx-qt, and as such, will require some minor modifications to provide hooks for
