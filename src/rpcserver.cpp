...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* KFX features */
        {"kfx", "masternode", &masternode, true, true, false},
        ...
        {"kfx", "mnbudget", &mnbudget, true, true, false},
        {"kfx", "preparebudget", &preparebudget, true, true, false},
        {"kfx", "submitbudget", &submitbudget, true, true, false},
        {"kfx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"kfx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kfx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kfx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kfx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kfx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kfx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kfx", "checkbudgets", &checkbudgets, true, true, false},
        {"kfx", "mnsync", &mnsync, true, true, false},
        {"kfx", "spork", &spork, true, true, false},
        {"kfx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"kfx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29939/\n";
}
