...
// Copyright (c) 2015-2017 The KFX developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("KFX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KFX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kfx: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zKFX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KFX Core"), this);
    aboutAction->setStatusTip(tr("Show information about KFX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KFX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KFX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KFX addresses"));
    ...
    openAction->setStatusTip(tr("Open a KFX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KFX Core help message to get a list with possible KFX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KFX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KFX network", "", count));
}
...
{
    QString strTitle = tr("KFX Core"); // default title
